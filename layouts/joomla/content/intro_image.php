...
<?php if (isset($images->image_intro) && !empty($images->image_intro)) : ?>
	...
	<div class="pull-<?php echo htmlspecialchars($imgfloat, ENT_COMPAT, 'UTF-8'); ?> item-image col-md-5">
	<?php if ($params->get('link_titles') && $params->get('access-view')) : ?>
		...
		<?php endif; ?>
		src="<?php echo htmlspecialchars($images->image_intro, ENT_COMPAT, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($images->image_intro_alt, ENT_COMPAT, 'UTF-8'); ?>" itemprop="thumbnailUrl" class="img-responsive" /></a>
	<?php else : ?><img
		<?php if ($images->image_intro_caption) : ?>
